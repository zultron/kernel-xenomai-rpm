...
%global _gitrel    20130904git4c19bf9
%global _pre       ubc3
...
/lib/modules/%{xenomai_kpkg_version}.%{_target_cpu}
%{_libdir}/linuxcnc/ulapi-xenomai-kernel.so
%endif

%if ! %{_without_rtai_kernel}
%files	flavor-rtai-kernel
/lib/modules/%{rtai_kpkg_version}.%{_target_cpu}
%{_libdir}/linuxcnc/ulapi-rtai-kernel.so
%endif


%changelog
* Wed Sep  4 2013 John Morris <john@zultron.com> - 2.6.0-0.5.ubc3
- Update to 2.6.0-20130904git4c19bf9
